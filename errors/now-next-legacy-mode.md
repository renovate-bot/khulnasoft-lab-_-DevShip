...
- Uses Next.js build targets (`target: 'serverless'`) in `next.config.js`. [documentation](https://github.com/khulnasoft/next.js#summary)
- Does not make changes to your application dependencies
- Does not load `next.config.js` ([as per the serverless target documentation](https://github.com/khulnasoft/next.js#summary))
- Runs `npm install`
- Runs `npm run now-build`
...
- [Serverless target implementation](https://github.com/khulnasoft/now-builders/pull/150)
